    ...
    async function fetchProfile() {
      ...
      if (user && user.id) {
        ...
        if (data) {
          ...
          console.warn('No user_profile found for user id:', user?.id);
        }
      }
  ...
  return (
    <form className="max-w-5xl mx-auto p-8 bg-white rounded shadow" onSubmit={handleSubmit}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
        <input type="text" name="national_id" value={formData.national_id} onChange={handleChange} placeholder="National ID No" className="border rounded px-3 py-2" />
        ...
        <input type="text" name="first_name" value={formData.first_name} onChange={handleChange} placeholder="First name" className="border rounded px-3 py-2" />
        ...
        <input type="text" name="home_address" value={formData.home_address} onChange={handleChange} placeholder="Home address" className="border rounded px-3 py-2" />
        <input type="text" name="home_phone" value={formData.home_phone} onChange={handleChange} placeholder="Home phone number" className="border rounded px-3 py-2" />
        <input type="text" name="postal_address" value={formData.postal_address} onChange={handleChange} placeholder="Postal address" className="border rounded px-3 py-2" />
        <input type="text" name="cell_phone" value={formData.cell_phone} onChange={handleChange} placeholder="Cell phone number" className="border rounded px-3 py-2" />
        ...
        <input type="text" name="kin_name" value={formData.kin_name} onChange={handleChange} placeholder="Next of kin name" className="border rounded px-3 py-2" />
        <input type="text" name="kin_cell" value={formData.kin_cell} onChange={handleChange} placeholder="Next of kin cell number" className="border rounded px-3 py-2" />
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 items-end mb-4">
        ...
        <div className="flex flex-col">
          ...
          <input type="date" name="reg_date" value={formData.reg_date} onChange={handleChange} className="border rounded px-3 py-2" />
        </div>
      </div>
